...
struct particleAttributes {
	...
	glm::vec3 accel = glm::vec3(0, -2.0f, 0); //velocity variation
	glm::vec3 velocity = glm::vec3(0, 1.1f, 0);
	...
	float factorXWind = 0.00001f;
	float factorZWind = 0.000001f;
	float speedDropFall = 0.3f;
